...
public class UsuarioController {
    ...
    public ResponseEntity<UsuarioResponseDTO> cadastrar(@PathVariable Long administradoraId,
        ...
        Usuario salvo = usuarioService.cadastrar(usuario, dto.condominioId(), dto.unidadeId(), administradoraIdAutenticado);
        ...
        UsuarioResponseDTO resposta = new UsuarioResponseDTO(
                ...
                salvo.getUnidade() != null ? salvo.getUnidade().getId() : null
        );

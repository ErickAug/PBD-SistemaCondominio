...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        try {
            String usuarioLogin = jwtService.extrairUsuarioLogin(token);

            boolean aindaNaoAutenticado = SecurityContextHolder.getContext().getAuthentication() == null;

            if (usuarioLogin != null && aindaNaoAutenticado) {
                UserDetails userDetails = usuarioDetailsService.loadUserByUsername(usuarioLogin);
        ...
        } catch (JwtException | IllegalArgumentException excecaoDeToken) {
